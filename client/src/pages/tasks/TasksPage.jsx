  ...
  const loadProjectsAndUsers = useCallback(async () => {
    try {
      const [projectsRes, usersRes] = await Promise.all([
        ...
        api.get('/me/directory', { params: { limit: 200 } })
          .catch(() => api.get('/admin/employees', { params: { limit: 200 } }))
          .catch(() => api.get('/manager/team')),
      ]);
      ...
      const employeesData = usersRes?.data?.data || usersRes?.data;
      setUsers(
